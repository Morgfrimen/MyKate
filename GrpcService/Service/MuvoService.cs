...
{
    public sealed class MuvoService : Muvo.GetListMuvoService.GetListMuvoServiceBase
    {
...
#region Overrides of GetListMuvoServiceBase
        ...
        public override Task<MuvoListResponce> MuvoList(MuvoListRequest request, ServerCallContext context)
        {
